...
function displayWeatherData(data) {
    ...
    weatherTemperature.innerHTML = `<img src="img/temperature-icon.png" alt="Temperature icon"> ${data.main.temp} °C`;

    const weatherPressure = document.createElement('div');
    weatherPressure.className = 'weatherPressure';
    weatherPressure.innerHTML = `<img src="img/pressure-icon.png" alt="Pressure icon"> ${data.main.pressure} hPa`;

    const weatherHumidity = document.createElement('div');
    weatherHumidity.className = 'weatherHumidity';
    weatherHumidity.innerHTML = `<img src="img/humidity-icon.png" alt="Humidity icon"> ${data.main.humidity} %`;

    const weatherWind = document.createElement('div');
    weatherWind.className = 'weatherWind';
    weatherWind.innerHTML = `<img src="img/wind-icon.png" alt="Wind speed icon"> ${data.wind.speed} m/s`;
...
function displayForecastWeather(data) {
    ...
    data.list.forEach(element => {
        ...
        const weatherIcon = document.createElement('div');
        weatherIcon.className = 'forecastIcon';
        weatherIcon.innerHTML = `<img src="https://openweathermap.org/img/w/${element.weather[0].icon}.png" alt="Weather icon">`;
        ...
        const weatherTemperature = document.createElement('div');
        weatherTemperature.className = 'weatherTemperature';
        weatherTemperature.innerHTML = `<img src="img/temperature-icon.png" alt="Temperature icon"> ${element.main.temp} °C`;

        const weatherPressure = document.createElement('div');
        weatherPressure.className = 'weatherPressure';
        weatherPressure.innerHTML = `<img src="img/pressure-icon.png" alt="Pressure icon"> ${element.main.pressure} hPa`;

        const weatherHumidity = document.createElement('div');
        weatherHumidity.className = 'weatherHumidity';
        weatherHumidity.innerHTML = `<img src="img/humidity-icon.png" alt="Humidity icon"> ${element.main.humidity} %`;

        const weatherWind = document.createElement('div');
        weatherWind.className = 'weatherWind';
        weatherWind.innerHTML = `<img src="img/wind-icon.png" alt="Wind speed icon"> ${element.wind.speed} m/s`;
